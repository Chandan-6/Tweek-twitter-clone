...
export default function Messages() {
    ...
    return (
        <main className="w-[80%] flex justify-between items-start mx-auto min-h-screen relative">
            ...
            {/* search section */}
            <section className="w-[35%] h-screen outline outline-1 outline-gray-700 pt-4 flex flex-col justify-start items-start overflow-y-scroll scroll-container mx-auto">
                <div className="w-full self-center px-4 flex justify-start items-start gap-3 pb-2 mb-4">
                    ...
                    <p className="text-base font-semibold tracking-wide">Messages</p>
                </div>
                <div className="w-full self-center px-4 flex justify-start items-start gap-3 pb-2 mb-4">
            ...
            <div className="fixed right-0 top-0 w-[33%] min-h-screen pr-4">
                <MessageBar />
            </div>
        </main>
    )
